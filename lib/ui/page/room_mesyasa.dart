...
class MesyasRoomPage extends StatefulWidget {
  const MesyasRoomPage({super.key});

  @override
  State<MesyasRoomPage> createState() => _MesyasRoomPageState();
}

class _MesyasRoomPageState extends State<MesyasRoomPage> {
  final _controller = HomeController();

  @override
  void initState() {
    _controller.fetchMesyasRooms();
    super.initState();
  }
        ...
        children: [
          ...
          ListenableBuilder(
              ...
              builder: (BuildContext context, Widget? child) {
                ...
                return MesyasOtelList(items: _controller.mesyasRooms);
              }),
          Padding(
