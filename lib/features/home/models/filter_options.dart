class FilterOptions {
  ...
  Map<String, int>? withDiscount;
  Map<String, int>? isDesigner;
  ...
  factory FilterOptions.fromJson(Map<String, dynamic> json) => FilterOptions(
    ...
    priceType: json["price_type"] == null ? null : PriceType.fromJson(json["price_type"]),
    priceF: json["price_f"],
    priceT: json["price_t"],
    district: Map.from(json["district"]!).map((k, v) => MapEntry<String, Area>(k, Area.fromJson(v))),
    area: Map.from(json["area"]!).map((k, v) => MapEntry<String, Area>(k, Area.fromJson(v))),
    metro: Map.from(json["metro"]!).map((k, v) => MapEntry<String, Metro>(k, Metro.fromJson(v))),
    type: Map.from(json["type"]!).map((k, v) => MapEntry<String, String>(k, v)),
    withDiscount: Map.from(json["with_discount"]!).map((k, v) => MapEntry<String, int>(k, v)),
    isDesigner: Map.from(json["is_designer"]!).map((k, v) => MapEntry<String, int>(k, v)),
    rating: Map.from(json["rating"]!).map((k, v) => MapEntry<String, int>(k, v)),
    r: Map.from(json["r"]!).map((k, v) => MapEntry<String, R>(k, R.fromJson(v))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "metro": Map.from(metro!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
    "type": Map.from(type!).map((k, v) => MapEntry<String, dynamic>(k, v)),
    "with_discount": Map.from(withDiscount!).map((k, v) => MapEntry<String, dynamic>(k, v)),
    "is_designer": Map.from(isDesigner!).map((k, v) => MapEntry<String, dynamic>(k, v)),
    "rating": Map.from(rating!).map((k, v) => MapEntry<String, dynamic>(k, v)),
    "r": Map.from(r!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
    "h": h?.toJson(),
  };
}
