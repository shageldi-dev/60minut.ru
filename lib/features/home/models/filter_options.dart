class FilterOptions {
  ...
  factory FilterOptions.fromJson(Map<String, dynamic> json) => FilterOptions(
        ...
        area: Map.from(json["area"]!)
            .map((k, v) => MapEntry<String, Area>(k, Area.fromJson(v))),
        metro: Map.from(json["metro"]!)
            .map((k, v) => MapEntry<String, Metro>(k, Metro.fromJson(v))),
        type: Map.from(json["type"]!)
            .map((k, v) => MapEntry<String, String>(k, v)),
        withDiscount: Map.from(json["with_discount"]!)
            .map((k, v) => MapEntry<String, int>(k, v)),
        isDesigner: Map.from(json["is_designer"]!)
            .map((k, v) => MapEntry<String, int>(k, v)),
        rating: Map.from(json["rating"]!)
            .map((k, v) => MapEntry<String, int>(k, v)),
        r: Map.from(json["r"]!)
            .map((k, v) => MapEntry<String, R>(k, R.fromJson(v))),
        h: json["h"] == null ? null : H.fromJson(json["h"]),
        suggest: Map.from(json["suggest"]!)
            .map((k, v) => MapEntry<String, Suggest>(k, Suggest.fromJson(v))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "with_discount": Map.from(withDiscount!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "is_designer": Map.from(isDesigner!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "rating":
