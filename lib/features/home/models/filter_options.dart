class FilterOptions {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "district": district == null
        ? null
        : Map.from(district!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
    "area": area == null
        ? null
        : Map.from(area!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
    "metro": metro == null
        ? null
        : Map.from(metro!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
    "type": type == null ? null : Map.from(type!).map((k, v) => MapEntry<String, dynamic>(k, v)),
    "with_discount": withDiscount == null ? null : List<dynamic>.from(withDiscount!.map((x) => x)),
    "is_designer": isDesigner == null ? null : List<dynamic>.from(isDesigner!.map((x) => x)),
    "rating": rating == null ? null : List<dynamic>.from(rating!.map((x) => x)),
    "r": r == null
        ? null
        : Map.from(r!).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
